...
public class ItemController {
    ...
    public String list(Model model,
                       ...
                       @RequestParam(value = "category", defaultValue = "digital") String category
                       ){
        List<ItemForm> items = itemService.getItemList(pageNum,category);
    ...
    public String appliance(Model model, @RequestParam(value = "page", defaultValue = "1") Integer pageNum){
